...
pcontour(subs(sol2.x(1),t,0),full(casadi.DM(full(sol2.x(end)))),[-1 1 -1 1],'b')
hold on 
% reachability storage function at T = 0s
pcontour(subs(sol2.x(1),t,T),full(casadi.DM(full(sol2.x(end)))),[-1 1 -1 1],'g--')
