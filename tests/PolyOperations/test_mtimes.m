classdef test_mtimes < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function test_mtimes_single(testCase,testValue,refValue)
            ...
            actSolution = mtimes(testValue(1), testValue(2));

            refSolution = mtimes(refValue(1), refValue(2));
        ...
        function test_mtimes_multiple(testCase,testValue,refValue)
            ...
            actSolution = mtimes(testValue(1:10), testValue(11:20)');

            refSolution = mtimes(refValue(1:10), refValue(11:20)');
