classdef test_kron < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function test_kron_single(testCase,testValue,refValue)

            actSolution = kron(testValue(1), testValue(2));

            refSolution = kron(refValue(1), refValue(2));
        ...
        % 
        % function test_kron_multiple(testCase,testValue,refValue)
        % 
        %     actSolution = kron(testValue(1:10), testValue(11:20));
        % 
        %     refSolution = kron(refValue(1:10), refValue(11:20));
        % 
        %     c_sopt =  [];
        %     c_cas  =  [];
