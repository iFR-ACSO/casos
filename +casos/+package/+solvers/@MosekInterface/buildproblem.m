...
obj.solver_stats.SDP_data.size_A_nnz = nnz(prob.a);
obj.solver_stats.SDP_data.size_A     = size(prob.a);

% add size for the current conic solver
obj.solver_stats.conic.size_A = size(obj.args_in.a);
obj.solver_stats.conic.n_decVar = length(obj.args_in.x0);
