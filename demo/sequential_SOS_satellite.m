...
figure(1)
pcontour(subs(Vinit,x(3:end),zeros(4,1)),1,[-omega_max omega_max -omega_max omega_max])
hold on
...
pcontour(subs(g0,x(3:end),zeros(4,1)),0,[-omega_max omega_max -omega_max omega_max],'k')
...
figure(1)
pcontour(subs(Vsol,x(3:end),zeros(4,1)),1,[-omega_max omega_max -omega_max omega_max],'r')
