...
hold on
pcontour(subs(p,[x1;x4;x5;x6],zeros(4,1)),0.3,domain,'r')

subplot(312)
pcontour(subs(Vval,[x2;x4;x5;x6],zeros(4,1)),lvlSet,domain)
hold on
pcontour(subs(p,[x2;x4;x5;x6],zeros(4,1)),0.3,domain,'r')
subplot(313)
pcontour(subs(Vval,[x3;x4;x5;x6],zeros(4,1)),lvlSet,domain)
hold on
pcontour(subs(p,[x3;x4;x5;x6],zeros(4,1)),0.3,domain,'r')

figure()
subplot(311)
pcontour(subs(Vval,[x4;x1;x2;x3],zeros(4,1)),lvlSet,domain)
hold on
pcontour(subs(p,[x4;x1;x2;x3],zeros(4,1)),0.3,domain,'r')

subplot(312)
pcontour(subs(Vval,[x5;x1;x2;x3],zeros(4,1)),lvlSet,domain)
hold on
pcontour(subs(p,[x5;x1;x2;x3],zeros(4,1)),0.3,domain,'r')

subplot(313)
pcontour(subs(Vval,[x6;x1;x2;x3],zeros(4,1)),lvlSet,domain)
hold on
pcontour(subs(p,[x6;x1;x2;x3],zeros(4,1)),0.3,domain,'r')
...
lscaled = saveobj(l_scaled);
save('TermSet.mat','lscaled')
%% plotting
