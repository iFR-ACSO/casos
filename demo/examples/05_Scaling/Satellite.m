...
f_scaled = Dx*subs(x_dot,[x;u],[Dx^-1*x;-K_tilde*x])   % eq.(4)
...
figure()
subplot(311)
pcontour(subs(Vval,[x1;x4;x5;x6],zeros(4,1)),461,domain)
hold on
pcontour(subs(p,[x1;x4;x5;x6],zeros(4,1)),lvlSet,domain,'r')

subplot(312)
pcontour(subs(Vval,[x2;x4;x5;x6],zeros(4,1)),461,domain)
hold on
pcontour(subs(p,[x2;x4;x5;x6],zeros(4,1)),lvlSet,domain,'r')
subplot(313)
pcontour(subs(Vval,[x3;x4;x5;x6],zeros(4,1)),461,domain)
hold on
...
figure()
subplot(311)
pcontour(subs(Vval,[x4;x1;x2;x3],zeros(4,1)),461,domain)
hold on
pcontour(subs(p,[x4;x1;x2;x3],zeros(4,1)),0,domain,'r')

subplot(312)
pcontour(subs(Vval,[x5;x1;x2;x3],zeros(4,1)),461,domain)
hold on
pcontour(subs(p,[x5;x1;x2;x3],zeros(4,1)),lvlSet,domain,'r')

subplot(313)
pcontour(subs(Vval,[x6;x1;x2;x3],zeros(4,1)),461,domain)
hold on
